...
if (!$q_study) {
    echo "Error Study Planner: " . mysqli_error($koneksi);
}
if (!$q_event) {
    echo "Error Events: " . mysqli_error($koneksi);
}
                    ...
                    <div class="card-body scrollable-card">
                        <table class="table table-sm">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="2" class="text-muted">Tidak ada event.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    ...
                    <div class="card-body scrollable-card">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="2" class="text-muted">Jadwal belajar kosong.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    ...
                    <div class="card-body scrollable-card">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="3" class="text-muted">Belum ada project.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
