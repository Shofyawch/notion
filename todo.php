...
if (isset($_GET["hapus_reward"])) {
    ...
    mysqli_query($koneksi, "DELETE FROM reward WHERE id='$id'");
    header("Location: todo.php");
    exit;
}
// CHECK / UNCHECK
...
<head>
    ...
    <style>
        ...
        body {
            ...
            /* Mengganti Arial dengan Fredoka */
    ...
    <div class="container">
        ...
        <div class="section-box">
            ...
            <div class="reward-box" style="margin-bottom:15px;">
                <?php
                $rewards = mysqli_query($koneksi, "SELECT * FROM reward");
                foreach ($rewards as $reward): ?>
                    <div class="reward-item">
                        <label>✨<?= htmlspecialchars($reward['name']) ?><br></label>
                        <a href="todo.php?hapus_reward=<?= $reward['id'] ?>" style="margin-left:10px; color:#ff6b6b; text-decoration: none; font-size:0.9rem;" onclick="return confirm('Yakin hapus reward ini?')">
                            <i class="bi bi-trash-fill"></i>
                        </a>
                    </div>
            ...
            <form action="./add_reward.php" method="POST">
                <div style="display:flex; align-items:center;">
                    <input class="add-input" type="text" name="reward" placeholder="Tambah reward baru...">
                    <button class="add-btn" type="submit" style="width: 100px; margin-top:0;">Tambah</button>
                </div>
            </form>
        </div>
