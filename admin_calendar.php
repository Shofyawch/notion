...
<head>
    ...
    <title>Admin - Atur Kalender</title>
    <style>
        ...
        body {
            ...
            background-image: url('bg2.gif'); background-size: cover;
        ...
        .calendar-header { position: relative; display: flex; justify-content: space-between; align-items: center; padding: 20px; background: #ffc0cb; border-radius: 15px; border: 4px solid #333; width: 90%; max-width: 800px; margin-bottom: 20px; }
...
<body>
    ...
    <div id="mySidebar" class="sidebar">
        ...
        <a href="admin_calendar.php"><b>Atur Kalender</b></a>
    ...
    <script>
        ...
        function renderCalendar() {
            ...
            for (let i = 0; i < 6; i++) {
                ...
                if(hasDate || date <= daysInMonth) { calendarBody.appendChild(row); }
