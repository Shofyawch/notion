            ...
            <div class="metric-card bg-white p-6 rounded-2xl border-l-8 border-ghibli-kelp">
                <div class="flex items-center space-x-4">
                    <span class="text-4xl text-ghibli-kelp">
                        <svg class="w-10 h-10" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zm3 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 14a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1z"></path>
                        </svg>
                    </span>
                    <div>
            ...
            <div class="metric-card bg-white p-6 rounded-2xl border-l-8 border-ghibli-deep-sea">
                <div class="flex items-center space-x-4">
                    <span class="text-4xl text-ghibli-deep-sea">
                        <svg class="w-10 h-10" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM6 10a1 1 0 000 2h8a1 1 0 100-2H6zM4 14a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1z"></path>
                        </svg>
                    </span>
                    <div>
